...
# define BASELIB_COMPILER_IS_ARMCC 0
...
# undef BASELIB_COMPILER_IS_ARMCC
# define BASELIB_COMPILER_IS_ARMCC 1
...
# else
#  define BASELIB_COMPILER_VERSION_MAJOR (__GNUG__)
# endif
...
#  if defined(BASELIB_COMPILER_CXX_ALIGNAS) && BASELIB_COMPILER_CXX_ALIGNAS
...
#  if defined(BASELIB_COMPILER_CXX_ALIGNOF) && BASELIB_COMPILER_CXX_ALIGNOF
...
#  if defined(BASELIB_COMPILER_CXX_CONSTEXPR) && BASELIB_COMPILER_CXX_CONSTEXPR
...
#  if defined(BASELIB_COMPILER_CXX_FINAL) && BASELIB_COMPILER_CXX_FINAL
...
#  if defined(BASELIB_COMPILER_CXX_NOEXCEPT) && BASELIB_COMPILER_CXX_NOEXCEPT
...
#  if defined(BASELIB_COMPILER_CXX_NULLPTR) && BASELIB_COMPILER_CXX_NULLPTR
#    define BASELIB_NULLPTR nullptr
#  elif BASELIB_COMPILER_IS_GNU
#    define BASELIB_NULLPTR __null
#  else
#    define BASELIB_NULLPTR 0
#  endif


#  if defined(BASELIB_COMPILER_CXX_THREAD_LOCAL) && BASELIB_COMPILER_CXX_THREAD_LOCAL
